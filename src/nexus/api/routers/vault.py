...
from nexus.core.constants import VAULT_PATH, IGNORE_DIRS, PROJECT_ROOT
...
async def get_vault_structure(path: str | None = Query(default=None)):
    ...
    """
    try:
        from nexus.shared_tools.vault_reader import get_directory_tree
...
async def search_vault(
    ...
    try:
        from nexus.shared_tools.vault_reader import search_within
